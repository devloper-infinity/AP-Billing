...
{
    public partial class AddInvoiceRemoteUW1099 : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static int InsertRemoteUW1099Invoice(string Month, string Year, string InvoiceDate, string DueDate, string LoanCount, string InvoiceAmount, string InvoiceNumber, string InvoiceType)
        {
            ...
            htParam.Add("Remark", InvoiceType + '~' + InvoiceNumber);
        ...
        public static int InsertRemoteUW1099Excel(int InvoiceID, string Month, string Year)
        {
            int returnvalue = 0;
        ...
        //[WebMethod]
        //public static string VerifyRemoteUW1099(int InvoiceID, string Month, string Year)
        //{
        //    DataTable dt1 = new bllInvoice().GetIPSRemoteUW1099ForVerify(InvoiceID, Month, Year);
        ...
        //[WebMethod]
        //public void sendEmailAddNewInvoice_1099(int InvoiceId, string strInvoiceType)
        //{
        //    var mc_Laminr = new AddInvoiceLaminr();
