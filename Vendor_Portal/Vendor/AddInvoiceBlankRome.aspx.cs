...
{
    public partial class AddInvoiceBlankRome : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static int InsertRemoteUWAttorneyInvoice(string Month, string Year, string InvoiceDate, string DueDate, string LoanCount, string InvoiceAmount, string InvoiceNumber)
        {
            var mc_Attorney = new AddInvoiceBlankRome();
            int returnvalue = 0;
            //Convert.ToDateTime(InvoiceDate).ToString("MMM")
            string InvoiceType = "Attorney";
            ...
            htParam.Add("VendorName", "IPS LLC");
            htParam.Add("InvoiceType", "Attorney");
            ...
            htParam.Add("Remark", "Attorney" + '~' + Month + '-' + Year);
            returnvalue = new bllInvoice().Insert_Infinity_InvoiceDetails(htParam);
            if (returnvalue > 0)
            {
                mc_Attorney.sendEmailAddNewInvoice_Attorney(returnvalue,"Attorney");
            }
            return returnvalue;
        }
        ...
        public static int InsertRemoteUWAttorneyExcel(int InvoiceID, string Month, string Year)
        {
            int returnvalue = 0;
            ...
            if (NewFileName_RemoteExcel != "")
            {
                ...
                if (Extn == "xls" | Extn == "xlsx")
                {
                    ...
                    try
                    {
                        ...
                        objbulk.DestinationTableName = "AttorneyInvoiceDetails";
                        ...
                        objbulk.ColumnMappings.Add("TimeKeeper", "TimeKeeper");
        ...
        [WebMethod]
        public static string VerifyRemoteUWAttorney(int InvoiceID, string Month, string Year)
        {
            DataTable dt1 = new bllInvoice().GetIPSRemoteUWAttorneyForVerify(InvoiceID, Month, Year);
        ...
        [WebMethod]
        public void sendEmailAddNewInvoice_Attorney(int InvoiceId, string strInvoiceType)
        {
            var mc_Attorney = new AddInvoiceBlankRome();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                mc_Attorney.sendEmailInvoiceApproval_IPS(ToAddress, ToCC, "n.nilkanth@infinityinternationals.us,p.kedar@infinityinternationals.us,b.shubhangi@infinityinternationals.us", Subject, Path, htmlBody);
            }
