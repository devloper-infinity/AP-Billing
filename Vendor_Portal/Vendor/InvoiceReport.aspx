<%@ Page Title="" Language="C#" MasterPageFile="~/Vendor/Vendor.Master" AutoEventWireup="true" CodeBehind="InvoiceReport.aspx.cs" Inherits="Vendor_Portal.Vendor.InvoiceReport" %>
...
.card-header.p-0.pt-1 {
   ...
   #viewloanDetailsrpt_table th, 
#viewloanDetailsrpt_table td {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="card-header card-header-custom d-flex justify-content-between align-items-center" style="margin-bottom: 0px !important; min-height: 60px;">
            <div>
                <h5 class="m-0 font-weight-bold">
                    <i class="fas fa-copy"></i> All Invoice Report-IPS
            </h5>          
            </div>   
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <div class="card-body">
            <div style="width: 100%; overflow: auto;">
                <table class="table" id="invrpt_IPS" style="width: 100%;">
                    <thead>
                        <tr>
    ...
    <div class="modal fade" id="popUpViewLoanDetailsrpt">
    ...
    <span>&times;</span>
                ...
                <div class="modal-body">
                    <div style="width: 100%; overflow: auto;">
                        <table class="table" id="viewloanDetailsrpt_table" style="width: 100%;"></table>
                    </div>
                </div>
